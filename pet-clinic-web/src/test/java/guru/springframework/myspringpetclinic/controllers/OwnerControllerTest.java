...
class OwnerControllerTest {
    ...
    void processFindFormReturnOne() throws Exception {
        when(ownerService.findAllByLastNameLike(any())).thenReturn(List.of(Owner.builder().id(1L).build()));
    ...
    void processFindFormReturnMany() throws Exception {
        when(ownerService.findAllByLastNameLike(any())).thenReturn(new ArrayList<>(owners));
    ...
    void processFindForEmptyReturnMany() throws Exception {
        when(ownerService.findAllByLastNameLike(any())).thenReturn(List.of(
